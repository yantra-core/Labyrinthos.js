...
let jungleForest = new labyrinthos.Biome({
  name: 'jungleForest',
  tileset: tileset,
  distribution: {
    'grass': 0.3,
...
const lsystem = new labyrinthos.LSystem({
  ...
  generations: 2 // Number of transformations for more complex jungle growth
});
